...
<h1 align="center" style="margin: 30px 0 30px; font-weight: bold;">yuanQi v4.7.2</h1>
<h4 align="center">基于SpringBoot开发的轻量级Java快速开发框架</h4>
<p align="center">
	<a href="https://gitee.com/y_project/yuanQi/stargazers"><img src="https://gitee.com/y_project/yuanQi/badge/star.svg?theme=gvp"></a>
	<a href="https://gitee.com/y_project/yuanQi"><img src="https://img.shields.io/badge/yuanQi-v4.7.2-brightgreen.svg"></a>
	<a href="https://gitee.com/y_project/yuanQi/blob/master/LICENSE"><img src="https://img.shields.io/github/license/mashape/apistatus.svg"></a>
</p>

## 平台简介  此版本为前后端未分离 单体版本

一直想做一款后台管理系统，看了很多优秀的开源项目但是发现没有合适的。于是利用空闲休息时间开始自己写了一套后台系统。如此有了源起。她可以用于所有的Web应用程序，如网站管理后台，网站会员中心，CMS，CRM，OA。所有前端后台代码封装过后十分精简易上手，出错概率低。同时支持移动客户端访问。系统会陆续更新一些实用功能。
...
* 阿里云折扣场：[点我进入](http://aly.yuanQi.vip)，腾讯云秒杀场：[点我进入](http://txy.yuanQi.vip)&nbsp;&nbsp;
...
演示地址：http://yuanQi.vip  
文档地址：http://doc.yuanQi.vip
